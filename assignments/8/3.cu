/*
 * ============================================================
 * Solution file for Assignment 8 — Problem 3
 * Completed: Activation kernels, Loss functions, Adam optimizer
 * Filename: 3.cu
 * ============================================================
 */
...
/* A1, A2 provided (softmax kept as-is) */
...
{
    printf("\n========================================================\n");
    printf("  CUDA DIY Exercise 3: ML Primitives — Solution\n");
    printf("========================================================\n");
    ...
    printf("\n========================================================\n");
    printf("  Problem 3 solution run complete.\n");
    printf("========================================================\n\n");
    return 0;
}
