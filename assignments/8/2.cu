/*
 * ============================================================
 * Solution file for Assignment 8 — Problem 2
 * Completed: Parallel Reduction, Bank Conflict demo, Histogram
 * Filename: 2.cu
 * ============================================================
 */
...
/* Provided/shared utilities (copied from companion) */
...
/* B2: maxReduce (block-level max using shared memory tree) */
...
/* B3: Bank conflict access (timing demo) */
...
/* C1: Warp-level reduction using __shfl_down_sync */
__global__ void warpSumReduce(const float* data, float* out, int N)
{
    int i = blockIdx.x * blockDim.x + threadIdx.x;
    float val = (i < N) ? data[i] : 0.0f;

    /* Butterfly shuffle within warp */
    for (int offset = 16; offset > 0; offset >>= 1) {
        val += __shfl_down_sync(0xffffffffu, val, offset);
    }

    /* lane 0 of each warp accumulates to out */
...
{
    printf("\n========================================================\n");
    printf("  Solution: Problem 2 — Parallel Reduction & Shared Mem\n");
    printf("========================================================\n");
    ...
    printf("\n========================================================\n");
    printf("  Problem 2 solution run complete.\n");
    printf("========================================================\n\n");
    return 0;
}
